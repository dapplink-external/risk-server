...
func (c *notifierServicesClient) DepositWithdrawNotify(ctx context.Context, in *DepositWithdrawNotifyRequest, opts ...grpc.CallOption) (*DepositWithdrawNotifyResponse, error) {
	...
	err := c.cc.Invoke(ctx, NotifierServices_DepositWithdrawNotify_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedNotifierServicesServer should be embedded to have
...
func (UnimplementedNotifierServicesServer) DepositWithdrawNotify(context.Context, *DepositWithdrawNotifyRequest) (*DepositWithdrawNotifyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DepositWithdrawNotify not implemented")
}
func (UnimplementedNotifierServicesServer) testEmbeddedByValue() {}
...
func RegisterNotifierServicesServer(s grpc.ServiceRegistrar, srv NotifierServicesServer) {
	// If the following call panics, it indicates UnimplementedNotifierServicesServer was
