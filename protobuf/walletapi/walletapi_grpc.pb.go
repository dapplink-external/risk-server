...
const (
	WalletApiGateWayService_GetSupportChains_FullMethodName        = "/dapplink.WalletApiGateWayService/getSupportChains"
	WalletApiGateWayService_ConvertAddresses_FullMethodName        = "/dapplink.WalletApiGateWayService/convertAddresses"
	WalletApiGateWayService_ValidAddresses_FullMethodName          = "/dapplink.WalletApiGateWayService/validAddresses"
	WalletApiGateWayService_GetLastestBlock_FullMethodName         = "/dapplink.WalletApiGateWayService/getLastestBlock"
	WalletApiGateWayService_GetBlock_FullMethodName                = "/dapplink.WalletApiGateWayService/getBlock"
	WalletApiGateWayService_GetBatchBlock_FullMethodName           = "/dapplink.WalletApiGateWayService/getBatchBlock"
	WalletApiGateWayService_GetTransactionByHash_FullMethodName    = "/dapplink.WalletApiGateWayService/getTransactionByHash"
	WalletApiGateWayService_GetTransactionByAddress_FullMethodName = "/dapplink.WalletApiGateWayService/getTransactionByAddress"
	WalletApiGateWayService_GetAccountBalance_FullMethodName       = "/dapplink.WalletApiGateWayService/getAccountBalance"
	WalletApiGateWayService_SendTransaction_FullMethodName         = "/dapplink.WalletApiGateWayService/sendTransaction"
	WalletApiGateWayService_BuildTransactionSchema_FullMethodName  = "/dapplink.WalletApiGateWayService/buildTransactionSchema"
...
type WalletApiGateWayServiceClient interface {
	...
	GetBatchBlock(ctx context.Context, in *BatchBlockRequest, opts ...grpc.CallOption) (*BatchBlockResponse, error)
...
func (c *walletApiGateWayServiceClient) GetBatchBlock(ctx context.Context, in *BatchBlockRequest, opts ...grpc.CallOption) (*BatchBlockResponse, error) {
	out := new(BatchBlockResponse)
	err := c.cc.Invoke(ctx, WalletApiGateWayService_GetBatchBlock_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *walletApiGateWayServiceClient) BuildSponsoredTransfer(ctx context.Context, in *SponsoredTransferRequest, opts ...grpc.CallOption) (*SponsoredTransferBuildResponse, error) {
	...
	err := c.cc.Invoke(ctx, WalletApiGateWayService_BuildSponsoredTransfer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *walletApiGateWayServiceClient) SendSponsoredTransfer(ctx context.Context, in *SponsoredTransferSendRequest, opts ...grpc.CallOption) (*SendTransactionResponse, error) {
	out := new(SendTransactionResponse)
	err := c.cc.Invoke(ctx, WalletApiGateWayService_SendSponsoredTransfer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WalletApiGateWayServiceServer interface {
	...
	GetBatchBlock(context.Context, *BatchBlockRequest) (*BatchBlockResponse, error)
...
func (UnimplementedWalletApiGateWayServiceServer) GetBatchBlock(context.Context, *BatchBlockRequest) (*BatchBlockResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBatchBlock not implemented")
}
...
func (UnimplementedWalletApiGateWayServiceServer) BuildSponsoredTransfer(context.Context, *SponsoredTransferRequest) (*SponsoredTransferBuildResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BuildSponsoredTransfer not implemented")
}
func (UnimplementedWalletApiGateWayServiceServer) SendSponsoredTransfer(context.Context, *SponsoredTransferSendRequest) (*SendTransactionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendSponsoredTransfer not implemented")
}
...
func _WalletApiGateWayService_GetBatchBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchBlockRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WalletApiGateWayServiceServer).GetBatchBlock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WalletApiGateWayService_GetBatchBlock_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletApiGateWayServiceServer).GetBatchBlock(ctx, req.(*BatchBlockRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WalletApiGateWayService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dapplink.WalletApiGateWayService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "getBatchBlock",
			Handler:    _WalletApiGateWayService_GetBatchBlock_Handler,
		},
		{
	...
	Metadata: "dapplink/walletapi.proto",
}
